...
RSpec.describe InstJobsStatsd::Stats::Timing do
  ...
  describe "report_tinming" do
    context "with a block" do
      it "reports the elapsed time" do
        ...
        described_class.report_timing("test", job: job) { sleep 0.001 }
      end
    end
    ...
    context "without a block" do
      it "reports the given time" do
        ...
        described_class.report_timing("test", job: job, timing: 123)
      end
    end
  end
  ...
  describe "report_job_timing_queued" do
    it "reports the stat" do
      ...
      described_class.report_job_timing_queued(job)
    end
  end
  ...
  describe "report_job_timing_failed" do
    it "reports the stat" do
      ...
      described_class.report_job_timing_failed(job)
    end
  end
end
